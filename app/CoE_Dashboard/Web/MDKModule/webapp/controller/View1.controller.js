sap.ui.define([
	...
	return Controller.extend("CoE_Dashboard_CoE_Dashboard.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("CoE_Dashboard_CoE_Dashboard/mdkindex.html?" + queryString);
